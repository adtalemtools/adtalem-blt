...
namespace Adtalem\Blt\Plugin\Commands\Acsf;
...
/**
 * Defines commands in the "adtalem:acsf:site:data" namespace.
 */
class SiteDataCommand extends BltTasks {
   ...
   * @hook pre-validate
   */
  public function processAcsfApiommandOptions(CommandData $commandData) {
   ...
   *
   * @command adtalem:acsf:site:data:backup
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:site:data:download
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:site:data:list
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:site:data:restore
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:site:data:sync
   * @executeInVm
   */
