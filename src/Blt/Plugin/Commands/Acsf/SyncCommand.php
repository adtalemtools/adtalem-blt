...
class SyncCommand extends BltTasks {
   ...
   *
   * @command adtalem:acsf:sync:all-sites
   * @aliases adtalem:acsf:sync:all
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:sync:site
   * @aliases adtalem:acsf:sync
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:sync:site:env
   * @aliases adtalem:env
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:sync:truncate
   ...
   *
   * @command adtalem:acsf:sync:files
   * @executeInVm
   */
   ...
   *
   * @command adtalem:acsf:sync:all-files
   * @executeInVm
   */
